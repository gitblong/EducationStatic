...
public class ChartUtils4 {
	...
	public static void setChartTheme() {
		...
		chartTheme.setAxisOffset(new RectangleInsets(0, 1, 0, 5));
		chartTheme.setDomainGridlinePaint(new Color(217, 217, 217));// X坐标轴垂直网格颜
		chartTheme.setRangeGridlinePaint(new Color(217, 217, 217));// Y坐标轴水平网格颜色
